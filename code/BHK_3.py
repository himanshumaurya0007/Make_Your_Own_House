...
def nextPageto3BHK1():
    ...
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\Construction_Plans\\3BHK1.jpg')
...
def nextPageto3BHK2():
    ...
    # functions
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\Construction_Plans\\3BHK2.jpg')
    cd_bg_label = Label(cd_plans_window, image=cd_bg_image)
    cd_bg_label.place(x=0, y=0)
    btnback = Button(cd_plans_window, text='Back', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
                     activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=8, height=1,
...
def nextPageto3BHK3():
    ...
    # functions
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\Construction_Plans\\3BHK3.jpg')
    cd_bg_label = Label(cd_plans_window, image=cd_bg_image)
    cd_bg_label.place(x=0, y=0)
    btnback = Button(cd_plans_window, text='Back', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
                     activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=8, height=1,
...
def nextPageto3BHK4():
    ...
    # functions
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\Construction_Plans\\3BHK4.jpg')
    cd_bg_label = Label(cd_plans_window, image=cd_bg_image)
    cd_bg_label.place(x=0, y=0)
    btnback = Button(cd_plans_window, text='Back', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
                     activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=8, height=1,
...
def nextPageto3BHK5():
    ...
    # functions
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\Construction_Plans\\3BHK5.jpg')
    cd_bg_label = Label(cd_plans_window, image=cd_bg_image)
    cd_bg_label.place(x=0, y=0)
    btnback = Button(cd_plans_window, text='Back', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
                     activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=8, height=1,
...
btn = Button(plans_page, text='Plan A', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
             activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=15, height=1, command= nextPageto3BHK1)
btn.place(x=900, y=180)
btn = Button(plans_page, text='Plan B', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
             activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=15, height=1, command= nextPageto3BHK2)
btn.place(x=900, y=290)
btn = Button(plans_page, text='Plan C', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
             activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=15, height=1, command= nextPageto3BHK3)
btn.place(x=900, y=400)
btn = Button(plans_page, text='Plan D', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
             activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=15, height=1, command= nextPageto3BHK4)
btn.place(x=900, y=510)
btn = Button(plans_page, text='Plan E', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
             activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=15, height=1, command= nextPageto3BHK5)
