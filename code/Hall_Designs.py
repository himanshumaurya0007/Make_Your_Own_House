...
def nextPageto2BHK1():
    ...
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\360 QR\\Hall_1 360.png')
...
def nextPageto2BHK2():
    ...
    # functions
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\360 QR\\Hall_2 360.png')
    cd_bg_label = Label(cd_plans_window, image=cd_bg_image)
    cd_bg_label.place(x=140, y=140)
    btnback = Button(cd_plans_window, text='Back', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
                     activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=8, height=1,
...
def nextPageto2BHK3():
    ...
    # functions
    cd_bg_image = ImageTk.PhotoImage(
        file='D:\\SanchitSanjayPatil\\Coding\\Clg\\sem4\\make-your-own-house\\resources\\360 QR\\Hall_3 360.png')
    cd_bg_label = Label(cd_plans_window, image=cd_bg_image)
    cd_bg_label.place(x=140, y=140)
    btnback = Button(cd_plans_window, text='Back', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1',
                     activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=8, height=1,
